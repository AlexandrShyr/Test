...
;(SimpleAdaptiveSlider.prototype._setActiveClass = function () {
	...
	(SimpleAdaptiveSlider.prototype._move = function () {
		if ('none' === this._direction)
			return (
				this._$items.classList.remove(TRANSITION_NONE), void (this._$items.style.transform = 'translateX('.concat(this._transform, '%)'))
			)
		if (!this._config.loop) {
		...
		'next' === this._direction
			? ++this._currentIndex > this._$itemList.length - 1 && (this._currentIndex -= this._$itemList.length)
			: --this._currentIndex < 0 && (this._currentIndex += this._$itemList.length),
			(this._transform = i),
	...
	(SimpleAdaptiveSlider.prototype._addEventListener = function () {
		...
		function e(t) {
			if (this._hasSwipeState) {
				...
				t.preventDefault(),
					this._config.loop ||
						(this._currentIndex + 1 >= this._$itemList.length && e >= 0 && (e /= 4), this._currentIndex <= 0 && e <= 0 && (e /= 4))
